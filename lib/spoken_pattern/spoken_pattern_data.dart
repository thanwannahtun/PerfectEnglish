...
final List<SpokenPattern> spokenPatterns = [
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ပင်ပင်ပန်းပန်း အလုပ်လုပ်ရတာကို ကျွန်တော် ကျင့်သားရနေပြီ။",
      },
    ],
  ),
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ကိုယ်မပြောင်းလဲနိုင်တဲ့ အရာတွေအတွက် စိတ်ပူနေလည်း အပိုပဲ။",
      },
      {
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      {"english": "The baby is about to cry.", "burmese": "ကလေးက ငိုတော့မယ်။"},
    ],
  ),
  SpokenPattern(
    title: "How about...?",
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ဒီဟင်းချက်နည်းအသစ်ကို စမ်းချက်ကြည့်ဖို့ စိတ်စောနေပါတယ်။",
      },
    ],
  ),
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "အစည်းအဝေးအချိန် ပြောင်းလို့ရမလားလို့ စဉ်းစားနေမိလို့ပါ။",
      },
      {
        "english": "I was wondering if you'd like to join us for dinner.",
        "burmese": "ကျွန်တော်တို့နဲ့အတူ ညစာစားဖို့ လိုက်မလားလို့ မေးကြည့်တာပါ။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ကျွန်တော့်သော့တွေကို ခင်ဗျားတွေ့မိလားလို့ မေးကြည့်တာပါ။",
      },
      {
    ...
    examples: [
      {
        ...
        "burmese": "အဲ့ဒီကိစ္စနဲ့ ပတ်သက်ပြီး အမြန်ဆုံး အကြောင်းပြန်ပေးပါ့မယ်။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ကျွန်တော့် အချိန်ဇယားကို စစ်ကြည့်ပြီးမှ ပြန်ပြောပေးပါ့မယ်။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "သူ့ရဲ့ ဆက်သွယ်ရန်လိပ်စာကို ကျွန်တော် ပြန်ပြောပေးပါ့မယ်။",
      },
      {
        "english": "I'll get back to you on whether I can attend the party.",
      ...
      },
      {
        ...
        "burmese": "ဒီဇိုင်းအပြောင်းအလဲတွေနဲ့ ပတ်သက်ပြီး ပြန်ပြောပေးပါ့မယ်။",
      },
      {
        "english": "I'll get back to you on the interview results next week.",
        "burmese": "အင်တာဗျူးရလဒ်တွေကို နောက်အပတ်မှာ အကြောင်းပြန်ပေးပါ့မယ်။",
      },
      {
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      {
        "english": "Could you walk me through your decision-making process?",
        "burmese":
      ...
      },
      {
        ...
        "burmese": "စာချုပ်ပါ အချက်အလက်တွေကို တစ်ခုချင်း ရှင်းပြပေးလို့ရမလား?",
      },
      {
        "english": "Could you walk me through the steps for troubleshooting?",
        "burmese":
      ...
      {
        "english": "Could you walk me through the workflow of your department?",
        "burmese":
  ...
  SpokenPattern(
    ...
    examples: [
      {
        "english": "To be honest with you, I don't think this is a good idea.",
        "burmese":
            "ပွင့်ပွင့်လင်းလင်း ပြောရရင်တော့ ဒါဟာ ကောင်းတဲ့ စိတ်ကူးလို့ ကျွန်တော် မထင်ဘူး။",
      },
      {
        "english": "To be honest with you, I haven't finished the report yet.",
        "burmese":
      ...
      {
        "english": "To be honest with you, I didn't really enjoy the movie.",
        "burmese":
      ...
      {
        "english": "To be honest with you, I need more time to think about it.",
        "burmese":
      ...
      },
      {
        ...
        "burmese": "အမှန်အတိုင်း ပြောရရင် ရလဒ်တွေအပေါ် ကျွန်တော် သိပ်အားမရဘူး။",
      },
      {
        "english": "To be honest with you, I think we should cancel the trip.",
        "burmese":
      ...
      {
        "english": "To be honest with you, I'm not a big fan of jazz music.",
        "burmese":
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "မင်းကို အချက်အလက်အမှားတွေ ပေးဖို့ ရည်ရွယ်ခဲ့တာ မဟုတ်ပါဘူး။",
      },
      {
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ကမ်းခြေသွားရမလား၊ တောင်ပေါ်သွားရမလား ဝေခွဲမရ ဖြစ်နေတယ်။",
      },
      {
      ...
      {
        "english": "I'm torn between the chocolate cake and the cheesecake.",
        "burmese":
      ...
      {
        "english": "I'm torn between renting an apartment or buying a house.",
        "burmese": "တိုက်ခန်းငှားနေရမလား၊ အိမ်ဝယ်လိုက်ရမလား စဉ်းစားရခက်နေတယ်။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ကားကို ဆက်ထားရမလား၊ ရောင်းလိုက်ရမလား ဝေခွဲမရ ဖြစ်နေတယ်။",
      },
      {
        "english": "I'm torn between the red one and the blue one.",
        "burmese": "အနီရောင်နဲ့ အပြာရောင်ကြားမှာ ဘယ်ဟာယူရမလဲ ဝေခွဲမရဖြစ်နေတယ်။",
      },
      {
    ...
    examples: [
      {
        ...
        "burmese": "ငါသာ မင်းနေရာမှာဆိုရင်တော့ အဲ့ဒီအခွင့်အရေးကို ယူလိုက်မှာ။",
      },
      {
        "english": "If I were you, I would talk to him first.",
        "burmese": "ငါသာ မင်းနေရာမှာဆိုရင်တော့ သူ့ကို အရင် စကားပြောကြည့်မှာ။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ငါသာ မင်းနေရာမှာဆိုရင် အဲ့ဒီစကားတွေကို လျစ်လျူရှုလိုက်မှာ။",
      },
      {
  ...
  SpokenPattern(
    title: "I'm dying to...",
    burmeseMeaning: "...ချင်လွန်းလို့ အသေအလဲပဲ / ...ဖို့ အရမ်းစောင့်မျှော်နေတာ",
    usage:
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "နောက်တစ်ပိုင်းကို ကြည့်ချင်လွန်းလို့ မစောင့်နိုင်တော့ဘူး။",
      },
    ],
  ),
  SpokenPattern(
    title: "You'd better...",
    burmeseMeaning: "မင်း ... လိုက်တာ ပိုကောင်းမယ် (မလုပ်ရင် ပြဿနာတက်နိုင်တယ်)",
    usage:
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "နောက်ဆုံးစာမေးပွဲအတွက် စာကို ကြိုးစားထားတာ ပိုကောင်းမယ်။",
      },
    ],
  ),
  SpokenPattern(
  ...
  SpokenPattern(
    ...
    usage: "သေချာပေါက် လုပ်ဆောင်တော့မယ့် အစီအစဉ်တွေကို ဖော်ပြတဲ့အခါ သုံးပါတယ်။",
    examples: [
      {
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "အခုချိန်မှာ နောက်ပြောင်တာတွေကို နားထောင်ဖို့ စိတ်မပါဘူး။",
      },
      {
  ...
  SpokenPattern(
    ...
    burmeseMeaning: "...ဘက်ကို ပိုပြီး စိတ်ယိုင်နေတယ် / ...ကို ပိုသဘောကျနေတယ်",
    usage:
    ...
    examples: [
      ...
      {
        "english": "I'm leaning towards the red one instead of the black one.",
        "burmese": "အမည်းရောင်ထက် အနီရောင်ကို ပိုသဘောကျနေတယ်။",
      },
      {
        "english": "They are leaning towards canceling the event.",
        "burmese": "သူတို့က ပွဲကို ဖျက်လိုက်ဖို့ဘက်ကို ပိုပြီး အားသန်နေကြတယ်။",
      },
      {
  ...
  SpokenPattern(
    ...
    usage: "အကြောင်းရင်းကို လုံးဝနားမလည်တော့တဲ့အခါ အသုံးများတဲ့ အပြောပုံစံပါ။",
    examples: [
      {
      ...
      },
      {
        ...
        "burmese": "ဒီနေ့ ဘာလို့ ဒီလောက် ပင်ပန်းနေတာလဲဆိုတာ စဉ်းစားလို့မရဘူး။",
      },
      {
        "english": "I have no idea why she left so early.",
        "burmese": "သူမ ဘာလို့ ဒီလောက် စောစောပြန်သွားတာလဲဆိုတာ လုံးဝ မသိဘူး။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ဒါက ဘာလို့ ဒီလောက် ဈေးကြီးနေရတာလဲဆိုတာ လုံးဝ စဉ်းစားမရဘူး။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "ဒီရာသီမှာ ဘာလို့ မိုးရွာနေတာလဲဆိုတာ လုံးဝ စဉ်းစားမရဘူး။",
      },
    ],
  ),

  // 5. Questions & Social Interaction
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ကိုယ်ရေးကိုယ်တာ မေးခွန်းတစ်ခု မေးရင် စိတ်မရှိပါနဲ့နော်။",
      },
      {
      ...
      },
      {
        ...
        "burmese": "နေ့လည်စာ အတူတူစားဖို့ ကျွန်တော်ပါ လိုက်ခဲ့ရင် အဆင်ပြေမလား?",
      },
      {
  ...
  SpokenPattern(
    ...
    examples: [
      ...
      },
      {
        ...
        "burmese": "ဒီနေ့အတွက် ဒီမှာပဲ တော်ကြရင် ဘယ်လိုလဲ? (အလုပ်သိမ်းရအောင်)",
      },
      {
  ...
  SpokenPattern(
    ...
    examples: [
      {
        "english": "I don't mean to be rude, but could you lower your voice?",
        "burmese":
            "ရိုင်းတယ်လို့တော့ မထင်စေချင်ဘူး၊ ဒါပေမယ့် အသံလေး နည်းနည်းလျှော့ပေးလို့ ရမလား?",
      },
      {
        "english": "I don't mean to be rude, but you're standing in my way.",
        "burmese":
      ...
      {
        "english": "I don't mean to be rude, but this isn't what I ordered.",
        "burmese":
      ...
      {
        "english": "I don't mean to be rude, but can we talk about this later?",
        "burmese": "ရိုင်းတယ်လို့ မဟုတ်ပါဘူး၊ ဒါကို နောက်မှ ပြောလို့ ရမလား?",
      },
      {
        "english":
